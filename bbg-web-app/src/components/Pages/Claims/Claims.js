...
// import FactoryWorkflow from "./Components/FactoryWorkflow/FactoryWorkflow";
// import VolumeTemplate from "./Components/VolumeTemplate";

// const Claims = ({history,type,location}) => {

//   const [index,setIndex] = useState(0);
//   const [edit,setEdit] = useState(false);

//   useEffect(() => {
//     if(location.state && location.state.type === "factory") {
//       setIndex(1);
//       setEdit(true)
//     }
//     else if (location.state && location.state.from === "history") {
//       setIndex(1);
//       setEdit(true)
//     }
//   }, [location])
...
//                 </TabPanel>
//                 <TabPanel>
//                   <CreateClaim type={!location.state?"volume":location.state.type} edit={edit} />
//                 </TabPanel>
//                 <TabPanel>
