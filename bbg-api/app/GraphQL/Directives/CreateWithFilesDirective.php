...
class CreateWithFilesDirective extends MutationExecutorDirective
{
    // Based off vendor/nuwave/lighthouse/src/Schema/Directives/CreateDirective.php
...
GRAPHQL;
    ...
    protected function makeExecutionFunction(?Relation $parentRelation = null): callable
    {
        ...
        return new SaveModelWithFile($parentRelation, $this->directiveArgs['fileModel']);
    }
}
