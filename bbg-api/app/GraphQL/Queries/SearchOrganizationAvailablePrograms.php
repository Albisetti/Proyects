...
class SearchOrganizationAvailablePrograms
{
    /**
     * @param null $_
    ...
    public function __invoke($_, array $args)
    {
        ...
        return \App\Models\Organizations::searchAvailablePrograms($orgId, (isset($args['excludeUsedProgram'])?$args['excludeUsedProgram']:false),(isset($args['search']) ? $args['search'] : null));
    }
}
