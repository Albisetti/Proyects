...
// Toggle mobile navigation states
function useToggleMobileNavigation() {
  const {
    context: { isMobileNavigationOpen },
    setContext,
  } = useContext(SiteContext)

  async function toggleMobileNavigation(state) {
    setContext((prevState) => {
      return {
        ...prevState,
