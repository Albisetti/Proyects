              ...
              <div className="header--content">
                <div className="logo">
                  {router.pathname === '/' ? (
                    ...
                    >
                      <Icon name="Logo" id="header" viewBox="0 0 100 40" />
                    </button>
                  ) : (
    ...
    return (
      <>
        ...
        >
          <div ref={headerRef} className="header--outer">
            <div className="header--inner">
              <div className="header--content text-15 font-bold">
                Header needs setup, please go to sanity dashboard
                desk/settings/header to configure
              </div>
            </div>
          </div>
        </header>
